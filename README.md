...
--------------------------------------
The data structure of the configuration files is designed to accommodate for versioning. There are 3 data sets as follows:

* `manifest.json` - Contains the master data and versioning reference of each blockchain.
...
COIN=100000000                  # Leave value set to `100000000`;
...
In this explanation, Blocknet wallet [v3.9.22](https://github.com/BlocknetDX/BlockDX/releases/tag/v3.9.22) will be used as an example throughout the process of creating an XBridge configuration file. The name this files is save as should be the same as the `ver_id` of the original `manifest.json` version group it was created for. Blocknet example: `"ver_id": "blocknet--v3.9.16"` yields `blocknet--v3.9.16.conf`;
...
COIN=100000000                  | Keep this value set to `100000000`. It represents the inverse value of 1 satoshi.
